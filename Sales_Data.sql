...
--Q 2 Which customer used a discount but still spend more than the average amount ?

select customer_id,purchase_amount from sales where discount_applied='yes' and purchase_amount>=(select avg (purchase_amount)from sales);

--Q 3 Which are the top 5 product with the highest average review rating ?

select item_purchased,round( avg (review_rating),2) as avg_review_rating from sales 
